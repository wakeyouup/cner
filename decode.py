...
def test(model, out_dir, data_file):
    ...
    f_ori = open(out_dir + "/golden_s1_card.txt", "w", encoding="utf-8")
    f_inf = open(out_dir + "/generated_s1_card.txt", "w", encoding="utf-8")
...
if __name__ == '__main__':
    ...
    state = torch.load('/home/xg/life_long_NER2/save/multitask/life_long/train_model_1125175959/card_1_1.911.pt', map_location=torch.device('cuda:0'))["model_state_dict"]
   # state = torch.load('/home/xg/life_long_NER2/save/life_long_all_diff/life_long/train_model_1125023312/norp_0_0.036.pt', map_location=torch.device('cuda:0'))["model_state_dict"]
   # state = torch.load('/home/xg/life_long_NER2/save/life_long_without_er/life_long/train_model_1125101353/norp_0_0.057.pt', map_location=torch.device('cuda:0'))["model_state_dict"]
   # state = torch.load('/home/xg/life_long_NER2/save/life_long/life_long/train_model_1125101725/norp_2_0.053.pt', map_location=torch.device('cuda:0'))["model_state_dict"]
    ...
    test_file = os.path.join(config.data_dir, "test_card" + ".csv")
    out_dir = "result_for_generate/ontonote_5"
