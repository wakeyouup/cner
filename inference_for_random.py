...
import time
import config_for_ll_all_random as config
import pandas as pd
...
auto_test("/root/life_long_QG/save/life_long_all_diff/life_long/train_model_821164325", "/root/life_long_QG/result/life_long/life_long_all_diff")
